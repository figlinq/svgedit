  ...
  async init (_S) {
    ...
    return {
      ...
      callback () {
        ...
        const titleStar = svgEditor.i18next.t(`${name}:buttons.0.title`)
        const titlePolygon = svgEditor.i18next.t(`${name}:buttons.1.title`)

        const buttonTemplate = `
            <se-flyingbutton id="tools_polygon" title="${fbtitle}">
              <se-button id="tool_star" title="${titleStar}" src="./images/star.svg">
              </se-button>
              <se-button id="tool_polygon" title="${titlePolygon}" src="./images/polygon.svg">
              </se-button>
            </se-flyingbutton>
          `
