...
export function plotItem(name, id, index){
    return `
    <a class="panel-block panel-list-item fq-plot-item noselect" data-ftype="plot" data-fid="` + id + `" data-index="` + index + `">
        <span class="panel-icon">
...
export function imageItem(name, id, index){
    return `
    <a class="panel-block panel-list-item fq-image-item noselect" data-ftype="image" data-fid="` + id + `" data-index="` + index + `">
        <span class="panel-icon">
