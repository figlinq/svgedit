...
const svgWhiteList_ = {
  ...
  image: [  'clip-path', 'clip-rule', 'filter', 'height',  'mask', 'opacity', 'requiredFeatures', 'systemLanguage', 'width', 'x', 'xlink:href', 'xlink:title', 'y', 'src', 'href', 'data-original_dimensions', 'data-fid', 'preserveAspectRatio' ],
